...
const (
	...
	// NSCityGML30Core and related constants define CityGML 3.0 namespaces.
	...
	// NSGML31 and NSGML32 define supported GML namespaces.
	NSGML31 = "http://www.opengis.net/gml"
	NSGML32 = "http://www.opengis.net/gml/3.2"

	// NSXLink defines the XLink namespace.
